...
public class DBDataSo {
    ...
    private String[] allColumns = {DBHelp.COLUMN_ID2, DBHelp.COLUMN_JAM2,
            DBHelp.COLUMN_NAME2};

    //DBHelper diinstantiasi pada constructor
    public DBDataSo(Context context) {
    ...
    public Barang createBarang(String jam, String nama) {
        ...
        values.put(DBHelp.COLUMN_JAM2, jam);
        values.put(DBHelp.COLUMN_NAME2, nama);

        // mengeksekusi perintah SQL insert data
        // yang akan mengembalikan sebuah insert ID
        long insertId = database.insert(DBHelp.TABLE_NAME2, null,
                values);
        ...
        Cursor cursor = database.query(DBHelp.TABLE_NAME2,
                allColumns, DBHelp.COLUMN_ID2 + " = " + insertId, null,
                null, null, null);
