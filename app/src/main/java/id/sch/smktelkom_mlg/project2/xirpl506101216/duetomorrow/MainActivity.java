...
public class MainActivity extends AppCompatActivity
    ...
    private void changePage(int id) {
        ...
        } else if (id == R.id.nav_senin) {
            fragment = new SeninFragment();
        } else if (id == R.id.nav_selasa) {
            fragment = new SelasaFragment();
        } else if (id == R.id.nav_rabu) {
            fragment = new RabuFragment();
        } else if (id == R.id.nav_kamis) {
            fragment = new KamisFragment();
        } else if (id == R.id.nav_jumat) {
