...
public class createOrEditNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (id > 0) {
            ...
            cursor.moveToFirst();
            String contentString = cursor.getString(cursor.getColumnIndex(id.sch.smktelkom_mlg.project2.xirpl506101216.duetomorrow.database.DB_COLUMN_CONTENT1));
            String titleString = cursor.getString(cursor.getColumnIndex(id.sch.smktelkom_mlg.project2.xirpl506101216.duetomorrow.database.DB_COLUMN_TITLE1));
